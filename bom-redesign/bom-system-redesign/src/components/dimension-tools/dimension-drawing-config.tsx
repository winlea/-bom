...
export const DimensionDrawingConfig: React.FC<DimensionDrawingConfigProps> = ({
  ...
  const handleDimensionChange = (id: number, field: keyof DimensionData, value: string) => {
    onDimensionsChange(dimensions.map((d) => (d.id === id ? { ...d, [field]: value } : d)));
  };
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <span>尺寸数据</span>
            <Button onClick={handleAddDimension} className="bg-blue-600 hover:bg-blue-700">
          ...
          {dimensions.length === 0 ? (
            ...
            <div className="space-y-4">
              {dimensions.map((dimension) => (
                <div key={dimension.id} className="border border-gray-200 rounded-lg p-4 bg-white">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-lg">尺寸 {dimension.id}</h3>
                    <Button onClick={() => handleRemoveDimension(dimension.id)} variant="destructive" size="sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => handleDimensionChange(dimension.id, 'type', value)}
                      >
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleDimensionChange(dimension.id, 'nominalValue', e.target.value)}
                        placeholder="输入名义值"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleDimensionChange(dimension.id, 'toleranceValue', e.target.value)}
                        placeholder="输入公差值"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleDimensionChange(dimension.id, 'datum', e.target.value)}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleDimensionChange(dimension.id, 'upperTolerance', e.target.value)}
                        placeholder="输入上公差"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleDimensionChange(dimension.id, 'lowerTolerance', e.target.value)}
                        placeholder="输入下公差"
                      />
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange('padding', parseInt(e.target.value) || 20)}
                min="10"
                max="100"
              />
            </div>
