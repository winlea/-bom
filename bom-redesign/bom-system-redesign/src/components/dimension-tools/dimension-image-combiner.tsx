...
import { Download, Save, Grid, Image as ImageIcon, Settings, RefreshCw, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex gap-4 mt-4">
            <Button onClick={generateCombinedPreview} disabled={isGenerating} className="bg-blue-600 hover:bg-blue-700">
              {isGenerating ? (
                <>
            ...
            <Button onClick={downloadPreview} disabled={!previewUrl} variant="outline">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            拼接预览
            <span className="text-sm font-normal text-gray-500">({dimensions.length} 个尺寸)</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {dimensions.map((dimension) => (
              <div key={dimension.id} className="border border-gray-200 rounded-lg p-3 bg-white">
                ...
                <div className="text-sm">
                  <p>
                    <strong>名义值:</strong> {dimension.nominalValue}
                  </p>
                  {dimension.characteristic && (
                    <p>
                      <strong>特性:</strong> {dimension.characteristic}
                    </p>
                  )}
                </div>
              </div>
