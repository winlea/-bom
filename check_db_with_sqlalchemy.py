...
with app.app_context():
    ...
    if 'bom_table' in tables:
        ...
        for bom in boms:
            print(f"  ID: {bom.id}, Project ID: {bom.project_id}, Part Number: {bom.part_number}")
    ...
    if 'import_logs' in tables:
        ...
        for log in logs:
            print(f"  ID: {log.id}, Project ID: {log.project_id}, Created Count: {log.created_count}, Errors Count: {log.errors_count}")
