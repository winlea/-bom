...
from bom_system.models.project import Project, ProjectType, ProjectStatus
from bom_system.models.part import Part, PartType, PartStatus
...
def create_sample_data():
    ...
    with app.app_context():
        ...
        try:
            ...
            # 检查是否已有尺寸数据
            existing_dimensions = Dimension.query.join(Part).filter(Part.project_id == project.id).count()
